...
import { Eye, EyeOff, MapPin, Activity, Group, Map as MapIcon, Star } from "lucide-react";
...
export function DesktopLeftRail({
  ...
  return (
    <aside className="flex w-[280px] flex-col overflow-y-auto border-r border-[oklch(28%_0.02_250/0.55)] bg-[oklch(17%_0.014_250)]">
      {/* Project card */}
      ...
      <div className="px-3.5 pt-3">
        ...
        {statuses.map((s) => {
          ...
          return (
            ...
            >
              <span className="h-2.5 w-2.5 rounded-full ring-2 ring-[oklch(14%_0.012_250)]" style={{ background: s.color }} />
      ...
      {/* Saved view footer */}
      <div className="mt-auto border-t border-[oklch(28%_0.02_250/0.55)] p-3.5">
        <button className="flex w-full items-center gap-2.5 rounded-lg border border-[oklch(28%_0.02_250/0.55)] bg-[oklch(20%_0.016_250)] px-2.5 py-1.5 transition hover:bg-[oklch(24%_0.018_250)]">
