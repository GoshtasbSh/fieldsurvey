...
export function MobileAddSheet({ open, projectId, statuses, initialCoords, onClose, onSaved }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute inset-x-0 bottom-0 flex max-h-[88dvh] flex-col rounded-t-2xl border-t border-[oklch(28%_0.02_250/0.55)] bg-[oklch(17%_0.014_250)] shadow-[0_-12px_40px_-8px_oklch(0%_0_0/0.6)]" style={{ paddingBottom: "env(safe-area-inset-bottom)" }}>
        <div className="flex justify-center py-2">
          <span className="h-1 w-10 rounded-full bg-[oklch(36%_0.025_250/0.7)]" />
        </div>
